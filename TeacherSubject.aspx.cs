...
namespace Attendance_System
{
    public partial class TeacherSubject : System.Web.UI.Page
    {
        ...
        {
            if (DropDownList1.SelectedValue == "Select Teacher" && DropDownList2.SelectedValue == "Select Course" && DropDownList5.SelectedValue == "Select Semester" && DropDownList3.SelectedValue == "Select of Year" && DropDownList4.SelectedValue =="Select Subject")
            {
            ...
            else
            {
                ...
                if (dt.Rows.Count == 1)
                {
                    Label1.Text = "Selected Teacher is already been Assigned to the selected Subject.";
                    Label1.ForeColor = System.Drawing.Color.Red;
                }
                else 
                {
                    ...
                    cmd.ExecuteNonQuery();
                    con.Close();
                    DropDownList1.SelectedItem.Value = "Select Teacher";
                    DropDownList2.SelectedItem.Value = "Select Course";
                    DropDownList4.SelectedItem.Value = "Select Subject";
                    Label1.Text = "SucessFuly Added";
