...
namespace Attendance_System
{
    public partial class Subject : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            if (dt.Rows.Count == 1)
            {
                Label1.Text = "The Subject " + TextBox1.Text.ToString() + " is already present for the selected Course=" + DropDownList1.SelectedItem.Text + ",Year=" + DropDownList2.SelectedItem.Text + "";
            ...
            else
            {
                ...
                cmd.ExecuteNonQuery();
                con1.Close();
                Label1.Text = "Subject add Successfully";
