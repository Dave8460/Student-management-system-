...
namespace Attendance_System
{
    public partial class Teacher_Lectures : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            else if (DropDownList2.SelectedValue == "Select Course" && TextBox1.Text == "")
            {
                Label1.Text = "Please Select All The Fields";
                Label1.ForeColor = System.Drawing.Color.Red;
            }
            ...
            else
            {
                ...
                if (Session["TeacherID"] != null)
                {
                    ...
                    SqlConnection con = new SqlConnection(str);
                    SqlDataAdapter sda = new SqlDataAdapter("select Date as Lecutre_Date,LTaken as Lecture_Taken from T_lectures where TID='" + teacherID + "'and Course='" + course + "' and Year='" + year + "'and Sem='" + sem + "' and Subject='" + subject + "' and Date='" + date + "'", con); 
                    
                    DataSet ds = new DataSet();

                    sda.Fill(ds,"T_Lectures");

                    Label1.Text = "Attendance Saved Successfully";
