<%@ Page Title="" Language="C#" MasterPageFile="~/TeacherMaster.Master" AutoEventWireup="true" CodeBehind="Mark_Attendence.aspx.cs" Inherits="Attendance_System.Mark_Attendence" %>
...
<center>
   ...
   <center> 
         <table algin="center" style="width:1200px; height:366px">
            ...
            <tr>
                <td colspan="10" align="center">
                    <asp:Button ID="Button1" runat="server" Text="Select" Font-Bold="true" Height="40px" Width="92px" OnClick="Button1_Click"></asp:Button>
                </td>
            </tr>
            <tr>
                <td colspan="10" align="center">
                    <asp:Label ID="Label4" runat="server" Font-Bold="true" ForeColor="#000000"></asp:Label>
                    <asp:Label ID="Label1" runat="server" Text=""></asp:Label>
                </td>
            </tr>
            <tr>
                <td colspan="10" algin="center">
            ...
            <tr>
                <td colspan="10" algin="center" align="center">
                     <asp:Button ID="Button2" runat="server" Text="Mark Attendane" Font-Bold="true" Height="41px" Width="144px" OnClick="Button2_Click" ></asp:Button>
                </td>
            </tr>
            <tr>
                <td colspan="10" align="center">
