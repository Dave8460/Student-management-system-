...
{
    public partial class Mark_Attendence : System.Web.UI.Page
    {
        ...
        {
            if(DropDownList1.SelectedValue == "Select Coruse" && DropDownList2.SelectedValue == "Select Year" && DropDownList5.SelectedValue == "Select Semester" && DropDownList4.SelectedValue== "Select" && DropDownList3.SelectedValue== "Select Subject") 
            {
                Label1.Text = "Please select all the fields.";
                Label1.ForeColor = System.Drawing.Color.Red;
            }
            else if(DropDownList1.SelectedValue == "Select Coruse")
            {
                Label1.Text = "Please select all the fields.";
                Label1.ForeColor = System.Drawing.Color.Red;
            }
            ...
            else if (DropDownList5.SelectedValue == "Select Semester" && DropDownList5.SelectedValue == "Select")
            {
                Label1.Text = "Please select all the fields.";
                Label1.ForeColor = System.Drawing.Color.Red;
            }
            else if (DropDownList5.SelectedValue == "Select Semester" && DropDownList5.SelectedValue == "Select Subject")
            {
                Label1.Text = "Please select all the fields.";
                Label1.ForeColor = System.Drawing.Color.Red;
            }
